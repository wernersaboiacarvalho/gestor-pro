...
import { Activity, Clock, Filter, Search, User } from 'lucide-react'
...
export default function ActivitiesPage() {
    ...
    }, [pagination.limit, pagination.skip, filterAction])
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-muted-foreground">
                    Log de todas as atividades realizadas no sistema
                </p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Filtre as atividades por tipo ou busque por descrição
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="flex flex-col gap-4 md:flex-row md:items-center">
                        <div className="flex-1">
                            <div className="relative">
                                ...
                                <Input
                                    placeholder="Buscar por descrição, ação ou usuário..."
                                    value={searchTerm}
                                            ...
                                            <TableCell className="max-w-[300px]">
                                                ...
                                                {activity.metadata && (
                                                    <pre className="mt-1 text-xs text-muted-foreground">
                                                        ...
                                                        {JSON.stringify(activity.metadata, null, 2).length > 100 && '...'}
                                                    </pre>
                                                )}
                                            </TableCell>
                                            <TableCell>
